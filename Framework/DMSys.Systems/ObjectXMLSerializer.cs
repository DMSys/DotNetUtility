    ...
    public static class ObjectXMLSerializer<T> where T : class // Specify that T must be a class.
    {
        ...
        public static T Load(string path, SerializedFormat serializedFormat)
        {
            ...
            switch (serializedFormat)
            {
                ...
                case SerializedFormat.StringXML:
                    serializableObject = LoadFromStringFormat(path);
                    break;
        ...
        /// <summary>
        /// Запазва обект в XML формат
        /// </summary>
        /// <param name="serializableObject"></param>
        /// <returns>XML String</returns>
        public static string Save(T serializableObject)
        {
            return SaveToDocumentFormat(serializableObject, null, null);
        }
        ...
        private static T LoadFromStringFormat(string aXML)
        {
            T serializableObject = null;

            using (TextReader textReader = new StringReader(aXML))
            {
        ...
        private static TextReader CreateTextReader(IsolatedStorageFile isolatedStorageFolder, string path)
        {
            ...
            if (isolatedStorageFolder == null)
                textReader = new StreamReader(path, System.Text.Encoding.UTF8);
            else
                textReader = new StreamReader(new IsolatedStorageFileStream(path, FileMode.Open, isolatedStorageFolder), System.Text.Encoding.UTF8);
        ...
        private static TextWriter CreateTextWriter(IsolatedStorageFile isolatedStorageFolder, string path)
        {
            ...
            if (isolatedStorageFolder == null)
                ...
                textWriter = new StreamWriter(new IsolatedStorageFileStream(path, FileMode.OpenOrCreate, isolatedStorageFolder), System.Text.Encoding.UTF8);
        ...
        private static string SaveToDocumentFormat(T serializableObject, Type[] extraTypes, IsolatedStorageFile isolatedStorageFolder)
        {
